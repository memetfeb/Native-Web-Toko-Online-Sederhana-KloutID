...
<?php
    ...
    $page = (isset($_POST['page']))? $_POST['page'] : 1;
        ...
        $brg=mysqli_query($con,"SELECT * from produk limit $limit_start, $limit");
        ...
        <div class="col-sm-3 mb-3">
          <div class="card" style="min-height: 14rem;" >
            ...
            <div class="card-body">
              <h6 class="card-title"><?php echo $b['namaproduk']; ?></h6>
              <p class="card-text"><?php echo"Rp. " . number_format($b['price'], 2, ".", ",");?></p>
            </div>
