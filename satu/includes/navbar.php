...
<?php 
	...
	$jum = mysqli_num_rows($menu);
		...
		while($isi = mysqli_fetch_array($menu)){
			...
			?>
			<li class="nav-item">
  				<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsem<?php echo$idkat;?>" aria-expanded="true" aria-controls="collapsem<?php echo$idkat;?>">
			    ...
			    <?php 	
  				...
  				while($a = mysqli_fetch_array($submen)){
  					?> 
			      <a class="collapse-item"><?php echo $a["namasubkategori"];?></a>
			    <?php } 
